...
registry.registerPath({ method: 'delete', path: '/server/{serverID}/invites/{inviteID}', operationId: 'deleteInvite', security: auth, request: { params: pid(['serverID', 'inviteID']) }, responses: { 200: { description: 'Deleted' }, 403: { description: 'Forbidden' }, 404: { description: 'Not found' } } })
registry.registerPath({ method: 'get',    path: '/invite/{inviteID}',               operationId: 'getInvite',        request: { params: pid(['inviteID']) },            responses: { 200: { description: 'Invite details + server name' }, 404: { description: 'Not found or expired' } } })
registry.registerPath({ method: 'post',   path: '/invite/{inviteID}/join',          operationId: 'joinViaInvite',    security: auth, request: { params: pid(['inviteID']) },            responses: { 200: { description: 'Joined server' }, 404: { description: 'Invite not found or expired' }, 409: { description: 'Already a member' } } })
