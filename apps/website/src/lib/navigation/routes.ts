...
export const LATERAL_ROUTES: RouteDef[] = [
    { path: "/", label: "Home", sectionIds: ["hero", "about", "features"] },
    {
        path: "/security",
        label: "Security",
        sectionIds: ["security-hero", "security-model", "security-comparison"],
    },
    {
        path: "/download",
        label: "Download",
    ...
    },
    {
        path: "/privacy",
        label: "Privacy",
        sectionIds: ["privacy-hero", "privacy-content"],
    },
    {
        path: "/about",
        label: "About",
        sectionIds: ["about-hero", "about-team"],
    },
    {
        path: "/compare/signal-vs-discord",
        label: "Compare",
        sectionIds: [
            "compare-hero",
            "compare-table",
