    ...
    pricing: [
        {
            tier: "Free",
            price: "$0",
            notes: "Self-hosted. No paid tiers. No feature gates.",
        },
    ],
    strengths: [
...
export const signal: Competitor = {
    ...
    pricing: [
        { tier: "Free", price: "$0", notes: "Donation-funded nonprofit." },
    ],
    strengths: [
    ...
    pricing: [
        {
            tier: "Free",
            price: "$0",
            notes: "Full features with file size and quality limits.",
        },
        {
            tier: "Nitro Basic",
            price: "$2.99/mo",
