...
3. `docs/explanation/platform-strategy.md` — cross-platform architecture (Tauri+Svelte desktop, React Native mobile, shared packages)
4. `docs/explanation/design-system.md` — Figma ↔ Storybook pipeline, Mitosis component strategy, designer/developer workflow
5. `docs/explanation/auth-comparison.md` — how auth works, our design decisions
6. `AGENTS.md` — implementation rules all contributors must follow
7. `docs/reference/testing-strategy.md` — how tests are structured
8. `docs/reference/logging.md` — pino logger setup, redaction, dev vs prod transport
9. `docs/reference/config.md` — env validation, secret hygiene, singleton pattern
10. `docs/reference/websocket.md` — WS connection lifecycle, auth handshake, async handler pattern
