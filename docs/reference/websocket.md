...
See also: [architecture.md](architecture.md) for the auth model and middleware order, [auth-comparison.md](../explanation/auth-comparison.md) for NaCl challenge-response design, [vex-overview.md](../vex-overview.md) for the WS protocol overview.
