...
| **argon2id** | Memory-hard password hashing algorithm planned to replace PBKDF2-SHA512 (1,000 iterations) in the server. Resistant to GPU/ASIC brute-force attacks. See migration path Tier 1 | [auth-comparison.md](explanation/auth-comparison.md) |
